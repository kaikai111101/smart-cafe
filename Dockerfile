...
ENV DB_HOST=dashboard-kaida.flycast
ENV DB_PORT=5432
ENV DB_DATABASE=smart_cafe_polished_smoke_5263_purple_water_1465
ENV DB_USERNAME=smart_cafe_polished_smoke_5263_purple_water_1465
ENV DB_PASSWORD=Ff8dWzjTcDydSiU
